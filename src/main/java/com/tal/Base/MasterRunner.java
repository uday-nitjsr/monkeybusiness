...
public class MasterRunner {
    ...
    public static void highlightAndScreenshot(WebDriver driver,WebElement element, String fileName) throws IOException {
        //highlight
    ...
    public void performAllButtonActions(List<Button> buttons,String elementName){
        for (Button button:buttons){
            ...
            WebElement ele = null;
            try {
                 ele = button.getButtonWebElement();
                ele.click();
                //check if button is clicked
                //take screenshot to page
                highlightAndScreenshot(driver,ele,elementName+button.button_text);
                //Add to report
    ...
    public void performAllCheckboxActions(List<CheckBox> checkBoxes, String elementName){
        for (CheckBox checkbox:checkBoxes){
            ...
            WebElement ele = null;
            try {
                ele = checkbox.getcheckboxWebElement();
                ele.click();
                //check if button is clicked
                //take screenshot to page
                highlightAndScreenshot(driver,ele,elementName+checkbox.checkbox_id+"check");
//                screenshot(driver,elementName+checkbox.checkbox_id+"check");
                ...
                ele.click();
                highlightAndScreenshot(driver,ele,elementName+checkbox.checkbox_id+"uncheck");
    ...
    public void peformAllTextboxActions(List<Textbox> textboxes,String elementName){
        ...
        for (Textbox textbox:textboxes){
            ...
            try {
                ...
                highlightAndScreenshot(driver,ele,elementName+textbox.textbox_id+i);
                //Add to report
                EmailableReport.addRowToResult(elementName,Textbox.class.getSimpleName(),"sent dummy text","screenshot/"+elementName+textbox.textbox_id+i+".png");
                ele.clear();
                highlightAndScreenshot(driver,ele,elementName+textbox.textbox_id+i+"clear");
                //Add to report
                EmailableReport.addRowToResult(elementName,Textbox.class.getSimpleName(),"Clear text","screenshot/"+elementName+textbox.textbox_id+i+"clear.png");
            }
            catch (Exception e){
                System.out.println(e.getMessage());
                try {
                    screenshot(driver,elementName+textbox.textbox_id+i+"failed");
                } catch (IOException e1) {
                    e1.printStackTrace();
                    EmailableReport.addRowToResult(elementName,Textbox.class.getSimpleName(),"action attempted"+e.getMessage()+"\nNo screenshot available","");
                }
                EmailableReport.addRowToResult(elementName,Textbox.class.getSimpleName(),"failed","screenshot/"+elementName+textbox.textbox_id+i+"failed.png");
            }
        }
    }
    ...
    public void performAllDropdownActions(List<Dropdown> dropdowns,String elementName){
        for (Dropdown dropdown:dropdowns){
            System.out.println("Class:"+dropdown.dropdown_class+" ID:"+dropdown.dropdown_id
                    +" Href:"+dropdown.dropdown_href+" Text:"+dropdown.dropdown_text);
            WebElement ele = null;
            try {
                ele = dropdown.getdropdownWebElement();
                ele.click();
                //check if button is clicked
                //take screenshot to page
                highlightAndScreenshot(driver,ele,elementName+dropdown.dropdown_text);
                //Add to report
                EmailableReport.addRowToResult(elementName+dropdown.dropdown_text,Dropdown.class.getSimpleName(),
                        "click","screenshot/"+elementName+dropdown.dropdown_text+".png");
            }
            catch (Exception e){
                System.out.println(e.getMessage());
                try {
                    ...
                    e1.printStackTrace();
                    EmailableReport.addRowToResult(elementName+dropdown.dropdown_text,Dropdown.class.getSimpleName(),
                            "Click attempted"+e.getMessage()+"\nNo screenshot available","");
                    break;
                }
                EmailableReport.addRowToResult(elementName+dropdown.dropdown_text,Dropdown.class.getSimpleName(),
                        "click attempt failed:"+e.getMessage(),"screenshot/"+elementName+dropdown.dropdown_text+".png");
            }
        }
    }
}
